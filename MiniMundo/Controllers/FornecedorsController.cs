...
namespace MiniMundo.Controllers
{
    public class FornecedorsController : Controller
    {
        ...
        public FornecedorsController(MiniMundoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FornecedorID,Nome,CategoriaID,CNPJ,NivelAcessoID")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FornecedorID,Nome,CategoriaID")] Fornecedor fornecedor)
        {
